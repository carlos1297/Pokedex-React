...
export default function PokemonID() {
	...
	useEffect(() => {
		...
		specialAttack.current.style.width = `${onePokemon.stats[3].base_stat + 100}px`
		specialDefense.current.style.width = `${onePokemon.stats[4].base_stat + 100}px`
			...
			<div className='container-stats'>
				...
				<div className='stats'>
					...
					<div className='stat-group'>
						...
						<span>Hp</span>
						<div className='progress-bar'><span ref={hp} className={`pro-bar ${onePokemon.types[0].type.name}`}></span></div>
					...
					<div className='stat-group'>
						<span>Defense</span>
						<div className='progress-bar'><span ref={defensa} className={`pro-bar ${onePokemon.types[0].type.name}`}></span></div>
						<span className='counter-stat'>
					...
					<div className='stat-group'>
						...
						<div className='progress-bar'><span ref={specialAttack} className={`pro-bar ${onePokemon.types[0].type.name}`}></span></div>
						<span className='counter-stat'>
					...
					<div className='stat-group'>
						...
						<div className='progress-bar'><span ref={specialDefense} className={`pro-bar ${onePokemon.types[0].type.name}`}></span></div>
						<span className='counter-stat'>
					...
					<div className='stat-group'>
						<span>Speed</span>
						<div className='progress-bar'><span ref={speed} className={`pro-bar ${onePokemon.types[0].type.name}`}></span></div>
						<span className='counter-stat'>
